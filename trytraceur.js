...
function printUsage(){
    ...
    print("&nbsp;:ref - open Traceur language feature reference")
    print("&nbsp;:clear - clear the shell")
    print("<br>")
}
print('Welcome to Try Traceur')
print('======================')
print('From the Traceur Web Site(http://code.google.com/p/traceur-compiler/): <br><br><i>Traceur is a JavaScript.next-to-JavaScript-of-today compiler that allows you to use features from the future *today*.</i>')
printUsage()
layout()
